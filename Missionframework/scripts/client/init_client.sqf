...
switch (KP_liberation_arsenal) do {
    ...
    case  17: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\cwr3_nato.sqf";};
    case  18: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\cwr3_wp.sqf";};
