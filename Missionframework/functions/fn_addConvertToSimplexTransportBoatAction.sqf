...
if (!canSuspend) exitWith {_this spawn KPLIB_fnc_addConvertToSimplexTransportBoatAction};
...
_statement = {
    ...
    [_target, getText (configFile >> "CfgVehicles" >> typeOf _target >> "displayName"), -1] call sss_transport_fnc_addBoat;
};
